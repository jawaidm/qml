...
#from qml import helpers
from django.conf import settings
from qml import helpers as qml_helpers
#from qml.components.main.models import SystemMaintenance
...
def is_model_backend(context):
    ...
    request = context['request']
    return qml_helpers.is_model_backend(request)
