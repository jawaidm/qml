...
WSGI_APPLICATION = 'qml.wsgi.application'

'''REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': (
        'qml.perms.OfficerPermission',
    )
}'''
...
MIDDLEWARE_CLASSES += [
    #'qml.middleware.BookingTimerMiddleware',
    #'qml.middleware.FirstTimeNagScreenMiddleware',
    #'qml.middleware.RevisionOverrideMiddleware',
    'whitenoise.middleware.WhiteNoiseMiddleware',
]
MIDDLEWARE = MIDDLEWARE_CLASSES
MIDDLEWARE_CLASSES = None

TEMPLATES[0]['DIRS'].append(os.path.join(BASE_DIR, 'qml', 'templates'))
#TEMPLATES[0]['DIRS'].append(os.path.join(BASE_DIR, 'qml','components','organisations', 'templates'))
#TEMPLATES[0]['DIRS'].append(os.path.join(BASE_DIR, 'qml','components','emails', 'templates'))
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'qml', 'cache'),
    }
}
STATIC_ROOT=os.path.join(BASE_DIR, 'staticfiles')
STATICFILES_DIRS.append(os.path.join(os.path.join(BASE_DIR, 'qml', 'static')))
STATICFILES_DIRS.append(os.path.join(os.path.join(BASE_DIR, 'qml', 'static', 'qml_vue', 'static')))
...
SUPPORT_EMAIL = env('SUPPORT_EMAIL', 'qml@' + SITE_DOMAIN).lower()
...
MEDIA_APP_DIR = env('MEDIA_APP_DIR', 'qml')
...
#CRON_CLASSES = [
#    'qml.cron.OracleIntegrationCronJob',
#]
